...
#define MEM_SIZE                (10*1024) /* 应用程序 发送大量数据 需要复制的，内存堆 应用于数据发送 */
...
/* PBUF_LINK_HLEN: the number of bytes that should be allocated for a
   link level header. */
	 //#define PBUF_LINK_HLEN              16 /* 暂时不知道 为什么 暂时屏蔽 */
...
/* TCP receive window. */
#define TCP_WND                 (4*TCP_MSS)   /* TCP 发送窗口大小，增大该值可以提升TCP性能 */
...
#define  TCP_KEEPINTVL_DEFAULT    500UL		 // 每0.5秒发送一次保活探测（该值默认为75S）
